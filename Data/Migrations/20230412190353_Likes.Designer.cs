...
namespace proj.Data.Migrations
{
    ...
    [Migration("20230412190353_Likes")]
    partial class Likes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("proj.Models.LikeModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj.Models.PostModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("proj.Models.CommentModel", b =>
                {
                    ...
                    b.HasOne("proj.Models.PostModel", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("proj.Models.LikeModel", b =>
                {
                    b.HasOne("proj.Models.CommentModel", "Comment")
                        .WithMany("Likes")
